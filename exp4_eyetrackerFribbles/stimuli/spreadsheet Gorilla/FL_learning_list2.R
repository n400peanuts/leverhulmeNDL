...
learningList <- learningList %>% 
  add_row(tibble_row( display = "practice",  
                      ...
                      leftLabel = '',
                      centerLabel = '<p style="font-size: 700%;">tob</p>'), .before = 3)
...
learningList <- learningList %>% 
  add_row(display = "practice", .before = 4, 
          ...
          rightLabel = '<p style="font-size: 700%;">wug</p>',
          buttonLeft = '',
          buttonCenter = '',
          leftLabel = '',
          centerLabel = '')
...
learningList <- learningList %>% 
  add_row(display = "practice", .before = 5, 
          ...
          buttonCenter = '',
          leftLabel = '<p style="font-size: 700%;">dep</p>',
          centerLabel = '')
...
learningList <- learningList %>% 
  add_row(display = "practice", .before = 7, 
          ...
          buttonCenter = '<p style="font-size: 500%;">Click for next trial</p>',
          leftLabel = '',
          centerLabel = '<p style="font-size: 700%;">tob</p>')
...
write.csv(learningList, file = paste0(outPath,"learning_list2.csv"), row.names = F)
