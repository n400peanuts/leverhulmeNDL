...
```{r load dataset}
myexp = read.csv(paste(localGitDir,"inputs/exponential_s1_1.csv", sep = ''));
summary(myexp);
```
...
```{r}
coca<-read.csv("C:/Users/eva_v/OneDrive/Documenti/UCL/For_sharing_EVA/Modelling/cocaKinshipFrequency.csv", header=T);
