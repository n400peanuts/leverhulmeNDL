...
\hypertarget{comparison-with-both-task-1-and-2}{%
\subsubsection{Comparison with both task 1 and
2}\label{comparison-with-both-task-1-and-2}}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{'speed-accuracy tradeoff - FL'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\NormalTok{ggthemes}\OperatorTok{::}\KeywordTok{theme_hc}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Average RT on trials"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{'speed-accuracy tradeoff LF'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"speed-acc tradeoff"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{preProcessing_files/figure-latex/unnamed-chunk-58-1.pdf}
