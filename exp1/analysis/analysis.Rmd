---
title: "FLO replication - analysis + results summary"
author: "Eva"
date: "6/15/2020"
output: html_document
---

This script works by loading the pre-processed files.
...
```{r}
generalizationPL <-read.table(paste(localGitDir, "/exp1/data/generalizationPL.txt", sep = ""), header = T, stringsAsFactors = T)

generalizationLP <-read.table(paste(localGitDir, "/exp1/data/generalizationLP.txt", sep = ""), header = T, stringsAsFactors = T)

contingencyJudgement <-read.table(paste(localGitDir, "/exp1/data/contingencyJudgment.txt", sep = ""), header = T, stringsAsFactors = T)

randomDot <-read.table(paste(localGitDir, "/exp1/data/randomDot.txt", sep = ""), header = T, stringsAsFactors = T)

learning <-read.table(paste(localGitDir, "/exp1/data/learning.txt", sep = ""), header = T, stringsAsFactors = T)
...
```{r}
rm(temp, temp2, timeout, subj, subjs, trials, trialstot, accdistr, problematicPeople, dumbPeople,p)
```
...
```{r Picture labels for loop FL low freq, echo=FALSE}

listSubj <- unique(pictureLabel[!(pictureLabel$subjID %in% badsubjs) & pictureLabel$learning=="FL",]$subjID)
temp <- NULL
...
for (i in 1:length(listSubj)){
  ...
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[1] <- 
    mean(pictureLabel[pictureLabel$subjID==subj &        
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='dep' & 
           pictureLabel$category==1 ,]$acc)
  # ROW 2
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[2] <-
    mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='bim' & 
           pictureLabel$category==2 ,]$acc)
  # ROW 3
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[3] <-
    mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='tob' & 
           pictureLabel$category==3 ,]$acc)
  # ROW 4                                              #MISMATCH -TYPE1
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[4] <-
    mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='dep' & 
           pictureLabel$category==2 ,]$acc)
  # ROW 5
   humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[5] <-
     mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='bim' & 
           pictureLabel$category==3 ,]$acc)
  # ROW 6
   humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[6] <-
     mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='tob' & 
           pictureLabel$category==1 ,]$acc)
  # ROW 7                                              #MISMATCH -TYPE2
   humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[7] <-
     mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='dep' & 
           pictureLabel$category==3 ,]$acc)
  # ROW 8
   humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[8] <-
     mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='bim' & 
           pictureLabel$category==1 ,]$acc)
  # ROW 9
   humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[9] <-
     mean(pictureLabel[pictureLabel$subjID==subj &
           pictureLabel$frequency==25 & 
           pictureLabel$resp=='tob' & 
           pictureLabel$category==2 ,]$acc)
...
```{r Picture labels for loop FL high freq, echo=FALSE}
...
for (i in 1:length(listSubj)){
  ...
  humansWeightsbyppts<- data.frame(
           subjID = as.factor(c(subj)),
           learning = as.factor(rep("FL",9)),
           frequency = as.factor(rep("high",9)),
           type = as.factor(c(rep("match",3), 
                    rep("mismatch-type1",3), 
                    rep("mismatch-type2",3))),
           label = as.factor(c("dep_cat1", "bim_cat2", "tob_cat3")),
...
```{r picture labels for loop LF low freq, echo=FALSE}

listSubj <- unique(pictureLabel[!(pictureLabel$subjID %in% badsubjs) & pictureLabel$learning=="LF",]$subjID)
temp <- NULL
...
```{r picture labels for loop LF high freq, echo=FALSE}
...
### save file
```{r}
write.table(pictureLabel, paste(localGitDir, "/exp1/data/pictureLabel.txt", sep = ""), col.names = T, row.names = F, quote = F)
```
...
```{r for loop FL low freq, echo=FALSE}

listSubj <- unique(labelPicture[!(labelPicture$subjID %in% badsubjs) & labelPicture$learning=="FL",]$subjID)
temp <- NULL
...
for (i in 1:length(listSubj)){
  ...
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[1] <- 
    mean(labelPicture[labelPicture$subjID==subj &        
           labelPicture$frequency==25 & 
           labelPicture$label=='dep' & 
           labelPicture$category==1 ,]$acc)
  # ROW 2
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[2] <-
    mean(labelPicture[labelPicture$subjID==subj &
           labelPicture$frequency==25 & 
           labelPicture$label=='bim' & 
           labelPicture$category==2 ,]$acc)
  # ROW 3
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[3] <-
    mean(labelPicture[labelPicture$subjID==subj &
           labelPicture$frequency==25 & 
           labelPicture$label=='tob' & 
           labelPicture$category==3 ,]$acc)
  # ROW 4                                              #MISMATCH -TYPE1
  humansWeightsbyppts[humansWeightsbyppts$subjID==subj,]$acc[4] <-
    mean(labelPicture[labelPicture$subjID==subj &
           labelPicture$frequency==25 & 
...
```{r for loop FL high freq, echo=FALSE}
...
```{r for loop LF low freq, echo=FALSE}

listSubj <- unique(labelPicture[!(labelPicture$subjID %in% badsubjs) & labelPicture$learning=="LF",]$subjID)
temp <- NULL
...
```{r for loop LF high freq, echo=FALSE}
...
### save data
```{r, eval=FALSE}
write.table(labelPicture, paste(localGitDir, "/exp1/data/labelPicture.txt", sep = ""), col.names = T, row.names = F, quote = F)
```
...
## save data
```{r, eval=FALSE}
write.table(conjudge, paste(localGitDir, "/exp1/data/conjudge.txt", sep = ""), col.names = T, row.names = F, quote = F)
```
...
#lollipop_modelWeight #uncomment for this plot
modelWeight$type<-recode(modelWeight$type, "mismatch-type1" = "mismatch")

barplot_modelWeight<- ggbarplot(modelWeight[modelWeight$type!="mismatch-type2",], x = "learning",
      color = "black",
      #fill = "learning",
      y = "equilibriumWeigths",
      facet.by = c("frequency","type"),
      ylab = "association strength",
      position = position_dodge(.8),
      palette = c("#bdbdbd","#636363"),
      title = "predictions of the Rescorla - Wagner simulation"
      ) +
  theme(legend.position = "none")
barplot_modelWeight
...
ggbarplot(associationStrengths, x = "learning",
      color = "black",
      fill = "what",
...
### save data
```{r, eval=FALSE}
write.table(humansTypeWeigths, paste(localGitDir, "/exp1/data/humansTypeWeigths.txt", sep = ""), col.names = T, row.names = F, quote = F)
```
...
lm1<-lmer(resp ~  type * frequency * learning  +(frequency|subjID), data = humansTypeWeigths[!(humansTypeWeigths$type=="mismatch-type2"),])
car::Anova(lm1)
summary(lm1)
```
...
## Estimates of the betas from the original FLO paper
...
#sd
highfreq_sd <- c(5*sqrt(n))
                    
lowfreq_sd <- c(5*sqrt(n)) 
...
```{r}
piclab_model2 <- glmer(acc ~  frequency*learning+ (frequency|subjID), 
         data = pictureLabel[pictureLabel$rt > 100 & !(pictureLabel$subjID %in% badsubjs),], 
         family="binomial",
         control=glmerControl(optimizer = "bobyqa"))

adjusted.piclab_model = adjust_intercept_model(piclab_model2, chance = log(0.33/(1-0.33)))


piclab_model.emm <- emmeans(piclab_model2 , ~ frequency* learning )
...
```{r}
labpic_model2 <- glmer(acc ~  frequency*learning + (frequency|subjID), 
         data = labelPicture[labelPicture$rt > 100 & labelPicture$rt <=2500 & !(labelPicture$subjID %in% badsubjs),], 
         family="binomial",
         control=glmerControl(optimizer = "bobyqa"))

adjusted.labpic_model = adjust_intercept_model(labpic_model2, chance = log(0.33/(1-0.33)))

labpic_model.emm <- emmeans(labpic_model2, ~ frequency* learning )
...
conjudge_model <- lmer(resp ~  learning.ct * frequency.ct +(frequency.ct|subjID), 
         data = conjudge[!(conjudge$subjID %in% badsubjs) & conjudge$acc==0,])

```

```{r}
summary(conjudge_model)
```

```{r}
conjudge_model2 <- lmer(resp ~  learning * frequency +(frequency|subjID), 
         data = conjudge[!(conjudge$subjID %in% badsubjs) & conjudge$acc==0,])

conjudge_model.emm <- emmeans(conjudge_model2 , ~ learning* frequency )
